...
import '../components/sign-in-with-google.dart';
import '../screens/inscription/index.dart';
...
class _SeConnecterState extends State<SeConnecter>
  ...
  void initState() {
    ...
    _iconAnimation = new CurvedAnimation(
        parent: _loginButtonController, curve: Curves.bounceOut);
          ...
          new Row(
              ...
              children: <Widget>[
                new Container(
                    ...
                    child: CircleAvatar(
                        backgroundImage:
                            new AssetImage('assets/images/medecin.png'),
                        radius: 75.0)),
              ]),
          new Row(
              mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              child: new TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(Icons.person_outline,
                                        color: utils.colorBase, size: 30.0)),
                          ...
                          child: Row(
                              ...
                              children: <Widget>[
                                new Icon(Icons.arrow_forward_ios,
                                    color: utils.colorBase, size: 18.0),
                                Text('Vous s\'inscrire',
                                    style: utils.myStyleGlobal),
                              ]),
                          onPressed: () {
                            Navigator.push(
                          ...
                          onPressed: () {
                            signInWithGoogle().then((String name) {
                              name.isEmpty
                                  ? Navigator
                                      .of(context)
                                      .pushNamed('/listemedecin')
                                  : Navigator
                                      .of(context)
                                      .pushNamed('/profilpatient');
                            });
                          }),
                    ])
              ]),
